...
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__("./src/util/jquery.js");
...
const CloudinaryJQuery = class CloudinaryJQuery extends _cloudinary__WEBPACK_IMPORTED_MODULE_0__["default"] {
  /**
  ...
  responsive(options) {
    ...
    if (responsive_resize && !responsiveResizeInitialized) {
      ...
      return jQuery(window).on('resize', () => {
        const debounce = Object(_util_firstNotNull__WEBPACK_IMPORTED_MODULE_2__["default"])(responsiveConfig.responsive_debounce, this.config('responsive_debounce'), 100);
        let reset = function() {
          if (timeout) {
            clearTimeout(timeout);
            return timeout = null;
...
// Serialize upload_params
  ...
  html_options.class = _util__WEBPACK_IMPORTED_MODULE_1__["trim"](`cloudinary_fileupload ${html_options.class || ''}`);
  if (options.multiple) {
